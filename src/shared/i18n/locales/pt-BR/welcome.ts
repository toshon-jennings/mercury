export default {
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao Mercury Remoto",
  connectRemoteTitle: "Conectar ao Mercury Remoto",
  connectRemoteSubtitle:
    "Insira a URL de um servidor da API do Mercury em execução.",
