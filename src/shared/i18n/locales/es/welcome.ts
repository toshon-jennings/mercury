export default {
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a Mercury remoto",
  connectRemoteTitle: "Conectarse a Mercury remoto",
  connectRemoteSubtitle: "Introduce la URL de un servidor de API de Mercury en ejecución.",
