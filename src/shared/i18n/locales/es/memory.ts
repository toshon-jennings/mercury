export default {
  title: "Memoria",
  subtitle:
    "Lo que Mercury recuerda sobre ti y tu entorno entre sesiones.",
  sessions: "Sesiones",
  messages: "Mensajes",
  memories: "Recuerdos",
  ...
  noMemoriesYet: "Todavía no hay recuerdos. Mercury guardará los datos importantes mientras chateas.",
  ...
  userProfileHint: "Cuéntale a Mercury sobre ti: nombre, rol, preferencias y estilo de comunicación.",
  providersHint: "Los proveedores de memoria conectables ofrecen a Mercury memoria avanzada a largo plazo. La memoria integrada (arriba) siempre está activa junto con el proveedor seleccionado.",
