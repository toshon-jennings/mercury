export default {
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote Mercury",
  connectRemoteTitle: "Connect to Remote Mercury",
  connectRemoteSubtitle: "Enter the URL of a running Mercury API server.",
