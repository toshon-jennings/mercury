export default {
  ...
  terminalAgentsSubtitle: "这里会显示被追踪的 CLI 会话，即使它们在后台运行。",
  terminalAgentsCount: "{{count}} 个已追踪",
  terminalAgentsUnavailable: "暂时无法加载已追踪的终端会话。",
  terminalAgentLabel: "CLI 代理",
  terminalAgentUntitled: "终端代理 {{id}}",
  terminalAgentStatus: "已追踪会话",
  terminalAgentMessages: "{{count}} 条消息",
  terminalAgentsEmpty: "启动一个 CLI 会话后，Hermes 会在这里显示它的追踪记录。",
